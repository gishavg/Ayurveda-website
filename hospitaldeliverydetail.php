...
<form method="POST" name="delivery">
          ...
          <table width="374" border="1" bgcolor="#CCFFFF">
<?php
include "connect.php";
	if(!$conn)
	{
		echo "not connected";
				...
				session_start();
$query="select medicinebookingid,patientid,patientname,typeofpayment,bookingdate,deliverydate,status from  medicinebooking  where status='delivered'&& hospitalusername='".$_SESSION["userid"]."'";
$query1=mysql_query($query);
$i=1;
echo "<tr><td colspan=8><p>PATIENT MEDICINE DELIVERY DETAILS</p></td></tr>";
echo "<tr><th>slno</th><th>Medicine booking id</th><th>Patientid</th><th>Patientname</th><th>Type of payment</th><th>Booking date</th><th>Delivery date</th><th>Status</th></tr>";
