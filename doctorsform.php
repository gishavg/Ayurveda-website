...
<table width="480" border="0">
  <tr>
    <td colspan="3"> <div align="center">DOCTOR'S SCHEDULE </div></td>
  </tr>
  <tr>
    <td height="53" colspan="3">Doctor :
      <select name="dselect" style="width:100px;" onChange="onSelectChange();">
	  <?php
	  include "connect.php";
	  session_start();
	  $query="select * from doctorregistration where status='Currently present' && hospitalid='".$_SESSION["userid"]."'";
	  $result=mysql_query($query);
	  while($row=mysql_fetch_array($result))
	  {
	  ?>
	  
	   <option value="<?php echo $row["doctorusername"]; ?>" 
	                  <?php  if(isset($_POST["dselect"])) 
					         { if ($_POST["dselect"] == $row["doctorusername"]) echo " selected=selected";  }    ?> > 
					  <?php echo $row["doctorname"]; ?>	   </option>
     <?php 
	 }
	 ?>
      </select>
...
<input type="hidden" name="s7" value="<?php echo $s7; ?>" /></td>
  ...
  <tr>
    ...
    <td colspan="2"><div align="center">OP days </div></td>
  </tr>
  <tr>
...
Monday       </td>
    <td>  
        <div align="center">
           <input name="m1" type="text" value="<?php echo $mo1?>" size="3"  />
          <input name="m11" type="text" value="<?php echo $mo11?>" size="3" />  
        </div>      </td>
    <td>
      <div align="center">
        <input name="e1" type="text" value="<?php echo $ev1?>" size="3"/> 
		<input name="e11" type="text" value="<?php echo $ev11?>" size="3"/> 
      </div></td>
  </tr>
  <tr>
    <td>
      Tuesday     </td>
    <td><div align="center">
      <input name="m2" type="text" value="<?php echo $mo2?>" size="3" />
      <input name="m22" type="text" value="<?php echo $mo22?>" size="3" />
    </div>   </td>
    <td><div align="center">
      <input name="e2" type="text" value="<?php echo $ev2?>" size="3"/>
      <input name="e22" type="text" value="<?php echo $ev22?>" size="3"/>
    </div></td>
  </tr>
  <tr>
    <td>
      Wednesday</td>
    <td><div align="center">
      <input name="m3" type="text" value="<?php echo $mo3?>" size="3"/>
      <input name="m33" type="text" value="<?php echo $mo33?>" size="3"/>
    </div>   </td>
    <td><div align="center">
      <input name="e3" type="text" value="<?php echo $ev3?>" size="3"/>
	  <input name="e33" type="text" value="<?php echo $ev33?>" size="3"/>
    </div></td>
  </tr>
  <tr>
    <td>
      Thursday</td>
    <td><div align="center">
      <input name="m4" type="text" value="<?php echo $mo4?>" size="3"/>
      <input name="m44" type="text" value="<?php echo $mo44?>" size="3"/>
    </div>   </td>
    <td><div align="center">
      <input name="e4" type="text" value="<?php echo $ev4?>" size="3"/>
      <input name="e44" type="text" value="<?php echo $ev44?>" size="3"/>
    </div></td>
  </tr>
  <tr>
    <td>
Friday </td>
    <td><div align="center">
      <input name="m5" type="text" value="<?php echo $mo5?>" size="3"/>
      <input name="m55" type="text" value="<?php echo $mo55?>" size="3"/>
    </div>  </td>
    <td><div align="center">
      <input name="e5" type="text" value="<?php echo $ev5?>" size="3"/>
      <input name="e55" type="text" value="<?php echo $ev55?>" size="3"/>
    </div></td>
  </tr>
  <tr>
    <td>
      Saturday</td>
    <td><div align="center">
      <input name="m6" type="text" value="<?php echo $mo6?>" size="3"/>
      <input name="m66" type="text" value="<?php echo $mo66?>" size="3"/>
    </div>   </td>
    <td><div align="center">
      <input name="e6" type="text" value="<?php echo $ev6?>" size="3"/>
      <input name="e66" type="text" value="<?php echo $ev66?>" size="3"/>
    </div></td>
  </tr>
  <tr>
    <td>
      Sunday</td>
    <td><div align="center">
      <input name="m7" type="text" value="<?php echo $mo7?>" size="3"/>
      <input name="m77" type="text" value="<?php echo $mo77?>" size="3"/>
    </div>   </td>
    <td><div align="center">
      <input name="e7" type="text" value="<?php echo $ev7?>" size="3"/>
      <input name="e77" type="text" value="<?php echo $ev77?>" size="3"/>
    </div></td>
	<tr>
	<td colspan=2 align=center>
	<input type="submit" name="insert" value="<?php echo $caption ; ?>" /> </td>
  </tr>
  </table>
