...
<div id="templatemo_container">
	   ...
	   <table width="600" border=1 bgcolor="#CCFF66">
	   <p>   </p>
	   <caption align="center" style="font:Arial, Helvetica, sans-serif"><em><strong><h1><font color="#00FF00">MEDICINAL PLANTS</font></h1></strong></em></caption>
			<?php
				 include 'connect.php';
				 $s=mysql_query("select * from medicinalplants");
				 
				 while($r=mysql_fetch_array($s))
				 {
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					
					 echo "<td>".$r['plantname']."</td>";
					 echo "<td>".$r['plantscientificname']."</td>";
					 echo "<td>".$r['plantdescription']."</td>";
					  echo "<td><img src='".$r['picture']."' width=150 height=150></td>";
