  ...
  <div id="temppatienthome" > 
    	            ...
    	            <div id="templatemo_content_right_bottom">
						<div id="templatemo_content_right_top">
                       	  <div class="templatemo_post_area">
				              ...
				              <p>&nbsp;    </p>
				              <div> 
							  <div  style="position:absolute; top:879px; left: 559px; width: 215px; height: 0px;"></div>
	  <form  name="frm" method="post"  enctype="multipart/form-data" >
				...
				<?php
				 ...
				 include'connect.php';
				 $s=mysql_query("select * from hospitalregistration where hospitalusername='".$_GET["id"]."'");
				 echo "<tr>";
...
<p>
            ...
            <div id="templatemo_footer"><span style="position:absolute; top:910px; left: 873px; width: 215px; height: 0px;">
              <?php
				 include 'connect.php';
				 $su=mysql_query("select * from hospitalregistration where hospitalusername='".$_GET["id"]."'");
				  while($ru=mysql_fetch_array($su))
				  {
				  		echo "<a href=patientviewfacility.php?idd=".$ru['hospitalusername'].">View Facility & Treatments</a>";
						}
						?>
            </span>        </div>
