  ...
  <div>  <div style="background-color:#000000">
              ...
              <a href="adminservices.php">Services</a><span class="style8">"        "</span>
                ...
                <a href="index.php">LogOut</a></span></h2>
				 <table border=2  bgcolor="#CC99CC" width="200px" style="position:absolute; left: 598px; top: 98px;">
			 <caption align="top" ><h1><font color="#CCFFCC">HOSPITALS</font></h1></caption>
			<?php
				 include 'connect.php';
				 $s=mysql_query("select * from hospitalregistration");
				 
				 while($r=mysql_fetch_array($s))
				 {
					 echo "<tr><td>".$r['hospitalid']."</td>";
					 echo "<tr><td>".$r['hospitalname']."</td>";
					 echo "<td>".$r['hospitaladdress']."</td>";
					 echo "<td>".$r['hospitallocation']."</td>";
					 if($r['status']=="")
					 {
					 		echo "<td>";echo "<a href=adminstatusupdate.php?id=".$r['hospitalid'].">Update Status</a>";echo "</td>";
					 	    echo "</td></tr>";
					 }
					 else if($r['status']=="Accepted")
					 {
					 	
					 		echo "<td>";echo "<a href=adminaccepedhospitals.php?id=".$r['hospitalid'].">View Details</a>";echo "</td>";
