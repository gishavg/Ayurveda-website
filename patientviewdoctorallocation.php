  ...
  <div id="temppatienthome" > 
            ...
            <div id="templatemo_content">
              <div id="templatemo_content_left">
						...
						<div id="templatemo_content_right_top">
                        	<div class="templatemo_post_area">
							  ...
							  <table  bgcolor="#999999"><font color="#990099">
								<th><font color="#9900FF">Registered Hospitals....</font></th>
							 <?php
				 include 'connect.php';
				 $s=mysql_query("select hospitalusername,hospitalname from hospitalregistration");
			    ...
			    echo "<tr><td>";
					$name=$r['hospitalname'];
					echo "<a href=patientviewhospital.php?id=".$r['hospitalusername'].">$name</a>";
				  echo "</td></tr>";
