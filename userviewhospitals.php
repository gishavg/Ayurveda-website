...
<div id="templatemo_container">
                ...
                <div id="templatemo_content_right">
    	            <div id="templatemo_content_right_bottom">
						<div id="templatemo_content_right_top">
                        	<div class="templatemo_post_area" style="position:absolute; &gt;
                            	&lt;div&gt;&lt;form  name=; left: 451px; top: 357px;"frm" method="post"  enctype="multipart/form-data" >
                 <table border="1" width="500">
                 <font color="#FFFFFF">
                 <font face="Algerian"><em><h1>.......KERALA'S AYURVEDA HOSPITALS........</h1></em></font>
                   <?php
				// echo "KERALA'S AYURVEDA WEBSITE";
				 include'connect.php';
				 $s=mysql_query("select hospitalid,hospitalpicture from hospitalregistration where status='Accepted'");
				 ...
				 {
			    echo "<td>";
				 echo "<a href='userhospitalview.php?id=".$r["hospitalid"]."'><img src='".$r["hospitalpicture"]."' alt='Slider 02' width='350' height='300' /></a>";
				  echo "</td>";
				  $i++;
				 if($i%2==0)
				{
            ...
            <div class="templatemo_bottom_panel_section" style="position:absolute; left: 248px; top: 1010px;" >
