...
<div id="templatemo_container">
  ...
  <div>  <div style="background-color: #000000">
    ...
    <table border=1 align="center" width="244" height="100px" bgcolor="#FFFFFF">
          <caption align="center" >
            <h style="color:#FFFFFF">
            <font color="#FFFFFF" style="font-style:italic">FEEDBACKS</font>
          </caption>
          <tr>
            <th> SL NO: </th>
            <th> FEEDBACK: </th>
          ...
          <?php
				 ...
				 while($r=mysql_fetch_array($s))
				 {
				  ...
				  echo "<tr><td  width=50px>".$r['feedbackid']."</td><td width=25px>".$r['feedback']."</td></tr>";
				 }
				 ?>
    </table>
