...
<div id="templatemo_container">
  ...
  <div>  <div style="background-color:#000000">
              ...
              <a href="adminservices.php">Services</a><span class="style8">"        "</span>
				...
				<div style="position:absolute; left: 461px; top: 161px;">
				 <table border=2  bgcolor="#CCCCCC" width="100px">
			 <caption align="top" ><h1><font color="#FFFFFF">NEWS</font></h1></caption>
			<?php
				 include 'connect.php';
