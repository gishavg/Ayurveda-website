...
<div id="templatemo_container">
            ...
            <div id="templatemo_content">
         	 ...
         	 <p>&nbsp;</p>
         	 <p>&nbsp;</p>
         	 <table border=1 bgcolor="#CCCCCC" width="300" height="100">
			 <?php
session_start();
if($_SESSION['userid'])
...
echo "<h1><h2>WELCOME ,</h2></h1>".$_SESSION['userid'];
 ...
 include'connect.php';
					 			 $m=date("d-m-y");
							//	 session_start();
				// $su=mysql_query("select doctorname from doctorregistration where doctorid='".$_SESSION["userid"]."'");
				 	// while($ru=mysql_fetch_array($su))
				// {
				 //  $name1=$ru["doctorname"];	
				   
				  // } echo $name1;
				 $s=mysql_query("select * from doctorallocation where requesteddate='$m'");
			
				 echo "<tr><h2>PATIENT BOOKING DETAILS...</h2></tr>";
				 echo "<tr><th>Name</th><th>Booking Time</th>";
				 while($r=mysql_fetch_array($s))
				 {
				    echo "<tr><td>".$r["patientid"]."</td>";
					$name=$r["patientid"];
					echo "<td>".$r["allocationtime"]."</td>";
