...
<div style="position:absolute; top:25px; left:399px; background:#FFFFFF; width: 1px; height: 6px;"> 
 <table><tr><td valign=top><img src="images/doctorpic.jpg" width="150" /></td>
 
 </td></tr></table>
 <div style="position:absolute; left: 169px; top: 204px;"></div>
 <div class="cleaner"></div>
						<!-- End Of Right Top -->			
					<!-- En					</div><!-- End Of Right Bottom -->	
        <div class="cleaner"></div>		
					<div id="templatemo_content_right_bottom_section" style="position:absolute;top:705px;right:-675px">
            ...
            <div class="templatemo_bottom_panel_section" style="position:absolute;top:1080px;right:-97px">
