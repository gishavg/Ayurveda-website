...
<td width="153" height="37">News Topic</td>
    <td width="18">:</td>
	
    <td>
      <label>
        <input type="text" name="news" value=<?php echo $newstopic?> />
      </label>    </td>
<td width="153" height="37"></td>
    ...
    <td>
      <label>
        <input type="hidden" name="" value=<?php echo $newsid ?> />
      </label>    </td>

    
  </tr>
  <tr>
    <td height="36">News Description</td>
    <td>:</td>
    <td><label>
      <input type="text" name="newsdesc" value=<?php echo $newsdescription ?>/>
    </label></td>
  </tr>
...
if(isset($_POST['submit']))
	{
		...
		$newsnews=$_POST['newsdesc'];
		$query="update news set newstopic='$newstopic',newsnews='$newsnews' where newsid='$newsid'";
