		  ...
		  <?php
				...
				session_start();
				 ...
				 $s=mysql_query("select facilityid,facility,facilitydescription from facilites where username='".$_SESSION["userid"]."'");
				 	 echo "<tr><th>slno</th><th>Facility Id</th><th>Facility</th><th>Facility description</th><th>Stock</th></tr>";
					 	$i=1;
						  echo "<i>VIEW FACILITIES</i>";
				 while($r=mysql_fetch_array($s))
				 {
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					// echo "<tr><td>".$r['treatmentid']."</td>";
						 echo "<td>$i</td>";
					 echo "<td>".$r['facilityid']."</td>";
					 echo "<td>".$r['facility']."</td>";
					 echo "<td>".$r['facilitydescription']."</td>";
					 echo "<td><a href='hospitalfacilityupdate.php?id=".$r["facilityid"]."'>Update</a></td>";
