...
<div id="templatemo_container">
  ...
  <div id="temppatienthome" > 
			 ...
			 <p>&nbsp;</p>
			 <p>&nbsp;</p>
			 <h1 class="style15"> BOOK YOUR HOSPITALS HERE........ </h1>
  </div>
    	            ...
    	            <div id="templatemo_content_right_bottom">
						<div id="templatemo_content_right_top">
                        	<div class="templatemo_post_area">
				              ...
				              <p>&nbsp;</p>
				              <p>&nbsp;    </p>
							  <table  bgcolor="#999999"><font color="#990099">
							
							<div > 
 <table border="1" width="500" height="200" bgcolor="#9999FF">
  <caption align="center"><font face="Algerian"><strong><h2>View your Facilities</h2></strong></font></caption>
 
		  <?php
		  		
		
				 include 'connect.php';
				 $s1=mysql_query("select facility,facilitydescription from facilites where username='".$_GET["idd"]."'");
				 	 echo "<tr><th>slno</th><th>Facility</th><th>Facility description</th></tr>";
					 	$i=1;
				 ...
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					// echo "<tr><td>".$r['treatmentid']."</td>";
					 ...
					 echo "<td>".$r1['facility']."</td>";
					 echo "<td>".$r1['facilitydescription']."</td>";
			 ...
			 echo "</td></tr>";
				 ...
				 <table border="1" width="500" height="200" bgcolor="#9999FF" >
		  <caption align="center"><font face="Algerian"><strong><h2>View Your Treatments</h2></strong></font></caption>
 
		  <?php
		  		
				 include 'connect.php';
				 $s=mysql_query("select treatment,treatmentdescription from treatments where username='".$_GET["idd"]."'");
				  
				  echo "<tr><th>slno</th><th>Treatment</th><th>Treatment description</th></tr>";
				 while($r=mysql_fetch_array($s))
				 {
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					// echo "<tr><td>".$r['treatmentid']."</td>";
					
					 echo "<td>".$r['treatment']."</td>";
					 echo "<td>".$r['treatmentdescription']."</td>";
