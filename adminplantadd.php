...
<div id="templatemo_container">
  ...
  <div ><div style="background-color:#000000">
		    ...
		    <img src="images/medi.jpg" width="235" height="249"/></div>
			
            <div id="templatemo_content">
            	
                <div id="templatemo_content_left">
					<div id="templatemo_menu" align="left" style="position:absolute; top:500px>
...
<div id="templatemo_content_right">
    	       ...
    	       <div style="position:absolute; right:200px; top:75px; height: 261px; width: 722px;"
 id="templatemo_content_right_bottom">
						<div>
                       	  <div style="position:absolute; right:169px; top:1px; height: 260px; width: 554px;" class="templatemo_post_area">
                           	  <h1 align="center" class="style12">&nbsp;</h1>
                            	<p class="style12"> <?php
				include "plantadd.php";
				?>&nbsp;			  
                            	</p>
                           	  <p>&nbsp;</p>
                          </div>
	  ...
	  <div id="templatemo_content_right_bottom_section"></div>
					<!-- End Of Right Bottom Section -->
                    <div class="cleaner"></div>	
              </div><!-- End Of Right -->
                <div class="cleaner"></div>
            </div><!-- End Of content -->
			<div align="center" class="templatemo_text_area">
