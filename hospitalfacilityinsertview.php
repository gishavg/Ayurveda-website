...
<p>&nbsp;</p>
            ...
            <div id="templatemo_content" style="position:absolute;top:122px;right:876px">
				...
				<!-- End Of Left -->
						...
						<a href="hospitalfacilityinsert.php"><font color="#FFFFFF">INSERT FACILITY</font></a><br>
                       <div class="templatemo_post_area" style="position:absolute; left:375px; top; top: 2px;">
       	   <?php
		  		
				session_start();
				 include 'connect.php';
				 $s=mysql_query("select facilityid,facility,facilitydescription from facilites where username='".$_SESSION["userid"]."'");
				 	
					
						  echo "<p align='center'><i><font color='#00CC00'>FACILITIES</font></i></p>";
				 ...
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					// echo "<tr><td>".$r['treatmentid']."</td>";
					 ...
					 echo "<tr><td align='center'><p><b><font color='#CC9933'>".$r['facility']."</font></b></p><br>";
					  echo "<font color='#999933'><b><u>Facility description</u></b></font><br><br>";
					 echo "<font color='#996666'>".$r['facilitydescription']."</font></td></tr>";
			 echo "</td></tr>";
			  echo "</table>";
        ...
        <div class="cleaner"></div>		
					<div id="templatemo_content_right_bottom_section" style="position:absolute;top:560px;right:-382px">
