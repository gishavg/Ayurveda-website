...
<div id="templatemo_container">
  ...
  <div id="temppatienthome" > 
            ...
            <div id="templatemo_content">
              <div id="templatemo_content_left">
    	            ...
    	            <div id="templatemo_content_right_bottom">
						<div id="templatemo_content_right_top">
                        	<div class="templatemo_post_area">
                            	<h1 class="style12">   <form  name="frm" method="post"  enctype="multipart/form-data" >
                 <table border="5" width="300" align="center" bgcolor="#33CCFF" bordercolor="#660066">
				...
				<?Php
				 ...
				 include'connect.php';
				 $s=mysql_query("select hospitalpicture,hospitalusername,status  from hospitalregistration");
				 echo "<tr>";
				 $i=0; 
				  echo "<tr>";
				 ...
				 $sta=$r["status"];
					...
					// echo "<td><img src='".$r['hospitalpicture']."' width=300 height=300></td>";
						    ...
						    echo "<td>";echo "<a href=patientmedicinebooking.php?username=".$r["hospitalusername"]."&ref=0><img src='".$r['hospitalpicture']."' width=300 height=300></a>";echo "</td>";				  echo "</td>";
				             $i++;
				        if($i%2==0)
				{
				  echo "</tr><tr>";
            ...
            <div class="templatemo_bottom_panel_section" align="center" >
