    	            ...
    	            <div id="templatemo_content_right_bottom">
						<div id="templatemo_content_right_top">
                        	<div class="templatemo_post_area">
                            	<h1 class="style12">Welcome to Kerala Ayurveda </h1>
                                <p>The word Ayurveda is a Sanskrit word that evolves from combination of two   words, &quot;Ayuh&quot; meaning life and &quot;veda&quot; meaning knowledge. Ayurveda &quot;Science of   Life&quot; or &quot;wisdom of life&quot; deals with nature and includes all aspects of life.   Ayurveda is a 6000year old science that originated in India and the components   and concept of Ayurveda is rooted in Vedas, the ancient book of knowledge that   dates around 3000BC. The component of the science that deals with health and   disease is known as Ayurvedic Medicine and came into existence around   1000BC.</p>
                                <p>Ayurvedic Medicine is the world's oldest comprehensive health care system and   is indigenous to India where it is widely practiced. &quot;This ancient art of   healing asserts that the science, philosophy and spirituality are all necessary   aspects of healthy living.&quot; Thus Ayurveda is not only a comprehensive medical   system but also a way of living and the very concept of &quot;mind, body and spirit&quot;   originates from Ayurveda.</p>
                                <p>It is now one of the most recognized and widely practiced disciplines of   alternative medicine in the world. Some of the popular practices of Ayurveda are   Meditation, Yoga, chanting, breathing exercises, Panchakarma and Herbs.</p>
                        	</div>
							<div class="templatemo_post_area">
							<div class="content" style="position:absolute;  right:226px; top:399px; width: 283px; height: 307px;">
  
     <h3 align="center" class="style17"><u>FAQ'S.............</u></h3>
     <blockquote>
       <marquee align="bottom" direction="up"  behavior="scroll" scrolldelay="-5" scrollamount="3s" bgcolor="#CCFF33" height="300" width="250">
       <?php 
	   session_start();
	   $_SESSION['userid']="";
	   include 'connect.php';
				 $s=mysql_query("select * from faq");
				 while($r=mysql_fetch_array($s))
				 {
				 	 echo "<h3>".$r['faqquestion']."</h3>"; 
					// echo "</br>";
					 echo "<h5>".$r['faqreply']."</h5>";
					  echo "</br>";
