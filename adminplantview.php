  ...
  <div>  <div style="background-color: #CCCCCC>
			...
			<?php
				 ...
				 //echo "<img src="$r['path']." alt='Slider 02' width='200' height='300' />";
					 echo "<tr><td>".$r['plantid']."</td>";
					 echo "<td>".$r['plantname']."</td>";
					 echo "<td>".$r['plantscientificname']."</td>";
					 echo "<td>".$r['plantdescription']."</td>";
					  echo "<td><img src='".$r['picture']."' width=100 height=100></td>";
					 echo "<td>";echo "<a href=adminplantedit.php?id=".$r['plantid'].">Edit</a>";echo "</td>";
					 echo "<td>";echo "<a href=adminplantdelete.php?id=".$r['plantid'].">Delete</a>";
					 echo "</td></tr>";
